...
if (isTRUE(Internal_match)) {
  ...
  colnames(DF_Output_SNVIndel_OnCore) <- append(colnames(STAMP_DF), colnames(OnCore_Biomarker_Report))
  ...
  remove(genes.OnCore_Biomarker,ncol_OnCore,ncol_SNVIndel,DF_Output_SNVIndel_OnCore)
