...
if (isTRUE(NCI_match)) {
                    ...
                    for (arm_num in 1:length(arm.match)) {
                      ...
                      if (isTRUE(exclusion_continue)) {
                        ...
                        patient_INFO <- DF_patient[which(DF_patient$CNV_Gene == gene_id &
                                                           DF_patient$var.type == "CNV" &
                                                           DF_patient$var.anno == "deletion"), CNV.colnames]
                      ...
                      remove(exclusion_continue,exclusion_Fusion_continue,exclusion_SNV_continue,file_name)
                    }
  ...
  remove(DF_Output_Patient_CNV_NonHotspot_int,DF_patient,genes.Inclusion_NonHotspot,ncol_InclusionNonHotspot,patient_id,patient_num,
         DF_Output_Patient_CNV_NonHotspot,CNV.colnames,ncol_CNV) 
}
